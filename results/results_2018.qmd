...
orioles_log_final_2018 <-
  read.csv(here("data", "baseball", "orioles_log_final_2018.csv"))
...
birds_2018_sf <-
  read.csv(here("data", "birds", "birds_2018.csv"))
...
ggplot() +
  ...
  geom_point(data = birds_2018_sf_fig1, 
