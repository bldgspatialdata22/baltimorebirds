...
orioles_log_final_2017 <-
  read.csv(here("data", "baseball", "orioles_log_final_2017.csv"))
...
birds_2017_sf <-
  read.csv(here("data", "birds", "birds_2017.csv"))
...
ggplot() +
  ...
  geom_point(data = birds_2017_sf_fig1, 
