...
orioles_log_final_2015 <-
  read.csv(here("data", "baseball", "orioles_log_final_2015.csv"))
...
birds_2015_sf <-
  read.csv(here("data", "birds", "birds_2015.csv"))
...
ggplot() +
  ...
  geom_point(data = birds_2015_sf_fig1, 
