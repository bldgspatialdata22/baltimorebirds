...
orioles_log_final_2019 <-
  read.csv(here("data", "baseball", "orioles_log_final_2019.csv"))
...
birds_2019_sf <-
  read.csv(here("data", "birds", "birds_2019.csv"))
...
ggplot() +
  ...
  geom_point(data = birds_2019_sf_fig1, 
