...
orioles_log_final_2021 <-
  read.csv(here("data", "baseball", "orioles_log_final_2021.csv"))
...
birds_2021_sf <-
  read.csv(here("data", "birds", "birds_2021.csv"))
...
ggplot() +
  ...
  geom_point(data = birds_2021_sf_fig1, 
