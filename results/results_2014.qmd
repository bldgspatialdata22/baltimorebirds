...
orioles_log_final_2014 <-
  read.csv(here("data", "baseball", "orioles_log_final_2014.csv"))
...
birds_2014_sf <-
  read.csv(here("data", "birds", "birds_2014.csv"))
...
ggplot() +
  ...
  geom_point(data = birds_2014_sf_fig1, 
