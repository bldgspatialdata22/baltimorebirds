...
orioles_log_final_2013 <-
  read.csv(here("data", "baseball", "orioles_log_final_2013.csv"))
...
birds_2013_sf <-
  read.csv(here("data", "birds", "birds_2013.csv"))
...
ggplot() +
  ...
  geom_point(data = birds_2013_sf_fig1, 
