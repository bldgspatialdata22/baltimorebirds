...
orioles_log_final_2016 <-
  read.csv(here("data", "baseball", "orioles_log_final_2016.csv"))
...
birds_2016_sf <-
  read.csv(here("data", "birds", "birds_2016.csv"))
...
ggplot() +
  ...
  geom_point(data = birds_2016_sf_fig1, 
